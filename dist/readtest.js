...
/***/ function(module, exports, __webpack_require__) {
	...
	var _textanalysis = __webpack_require__(2);

	var _stopwatch = __webpack_require__(3);
	...
	function injectView(extensionApi) {
	  ...
	  var start = (0, _utils.htmlToElement)('<div id="' + HEADER_ID + '" onClick="return false;">' + '<button id="' + RESTART_BUTTON_ID + '" type="button">' + lang("restart") + '</button>' + '<span id="' + HEADER_NOTIFICATION_ID + '">' + lang("timeStarted") + '</span>' + '<img id="' + HEADER_CLOSE_ID + '" alt="close" src="' + closeImgAbsoluteUrl + '"/>' + '</div>');
	  var selection = window.getSelection();
	  var wordsCount = (0, _textanalysis.countWords)(selection.toString());
	  var range = selection.getRangeAt(0);
	  range.insertNode(start);

	  // Collapse the range to a point that is at the end of the current range.
	  range.collapse();
	  var end = (0, _utils.htmlToElement)('<div id="' + FOOTER_ID + '" onClick="return false;">' + '<button id="' + FOOTER_DONE_BUTTON_ID + '" type="button">' + lang("done") + '</button>' + '<span id="' + FOOTER_WORDS_COUNT_ID + '">' + lang("words") + wordsCount + '</span>' + '<span id="' + FOOTER_TIMESPAN_ID + '"></span>' + '<span id="' + FOOTER_WMP_ID + '"></span>' + '<img id="' + FOOTER_CLOSE_ID + '" alt="close" src="' + closeImgAbsoluteUrl + '"/>' + '</div>');
	  ...
	  if (!(0, _utils.isElementInViewport)(start)) {
	  ...
	  doneButton.onclick = function () {
	    ...
	    setTextContent(FOOTER_TIMESPAN_ID, lang("time") + (0, _utils.formatTime)(delta));

	    var wpm = (0, _textanalysis.computeWpm)(wordsCount, delta);
...
/***/ function(module, exports) {
	...
	exports.computeWpm = computeWpm;
	/**
	 * Counts words in a string, where a word is a continous sequence of letters.
